...
* BSE and MCX as equity SYMBOLS (both are NSE-listed stocks, not just exchange names):
  - BSE Ltd. (Bombay Stock Exchange Ltd.) trades on NSE as ticker "BSE".
    ...
    → Cash equity: main_symbol "BSE", main_exchange "NSE",  main_segment "EQ"
    → Futures:     main_symbol "BSE", main_exchange "NFO",  main_segment "FUT"
    → Options:     main_symbol "BSE", main_exchange "NFO",  main_segment "OPT"
  - MCX Ltd. (Multi Commodity Exchange Ltd.) trades on NSE as ticker "MCX".
    "MCX as symbol" / "take MCX" / "MCX stock" / "can we take MCX" →
    → Cash equity: main_symbol "MCX", main_exchange "NSE",  main_segment "EQ"
    → Futures:     main_symbol "MCX", main_exchange "NFO",  main_segment "FUT"
    → Options:     main_symbol "MCX", main_exchange "NFO",  main_segment "OPT"
...

{
  ...
  "arguments": {
    "strategy_json": {
      "strategy_name": "<strategy name as given by user>",
