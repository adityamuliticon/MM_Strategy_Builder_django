...
* Equity stocks (RELIANCE, TCS, etc.):
  - ❌ WRONG: "RELIANCE options" → exchange "NSE", segment "EQ" — NEVER for F&O legs.
  - ✓ CORRECT: "RELIANCE options" → exchange "NFO", segment "OPT"; "RELIANCE future" → exchange "NFO", segment "FUT".
