"""ISE backtest service — fetches options, deducts points, polls for completion, and formats result tables."""
...
def run_backtest(strategy_id="", strategy_name="", start_date="", end_date=""):
    ...
    try:
        ...
        # This is the message that ACTUALLY triggers the backtest engine on the server.
