                    ...
                    try:
                        ...
                        if isinstance(data, dict):
                            if "tool" in data and "arguments" in data:
                                ...
                                for key in ["create_and_deploy_ise_strategy", "ise_validate_strategy", "ise_generate_payload", "get_my_strategies", "delete_strategy", "get_strategy_record", "modify_strategy"]:
                                    if key in data:
                                        tool_name = key
                                        val = data[key]
                                        if key in ("create_and_deploy_ise_strategy", "ise_validate_strategy", "ise_generate_payload"):
